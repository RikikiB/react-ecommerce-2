...
export default function TermsAndConditions() {
  return (
    <div className="TermsAndConditions" data-testid="TermsAndConditions">
      ...
      <h1>2. Interpretation and Definitions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to xyzcorp.com.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website.</strong> refers to xyzcorp.com, accessible from{" "}
            <a
              href="xyzcorp.com"
      ...
      <h1>7. &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
      <p>
      ...
      <h1>13. Translation Interpretation</h1>
      <p>
      ...
      <h1>14. Changes to These Terms and Conditions</h1>
      <p>
